...
import type { TTestimonialtype } from "../types/types";

const testimonials: TTestimonialtype[] = [
  {
    name: "Saurabh Kumar",
  ...
  return (
    <div className="px-4 py-10 md:py-20 font-sans max-w-7xl mx-auto">
      ...
      <p className="text-center text-gray-600 max-w-2xl mx-auto mb-10">
        Discover how thousands of sellers have transformed their businesses and
      ...
      >
        {testimonials.map((item, idx) => (
          <SwiperSlide key={idx}>
            <div className="bg-[#e6f4ff] rounded-xl p-4 shadow-md h-[370px] flex flex-col justify-between">
              <div>
                ...
                <p className="text-sm text-gray-700 line-clamp-4 leading-snug">
                  "{item.message}"
                </p>
              </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 text-center">
        {stats.map((stat, index) => (
          <div key={index}>
            <h4 className="text-2xl md:text-3xl font-bold text-[#003366]">
              {stat.title}
            </h4>
